...
func TestMetricsExposeCoreSeries(t *testing.T) {
	...
	for _, name := range []string{"tmk_http_requests_total", "tmk_http_request_duration_seconds", "tmk_websocket_audio_chunks_total", "tmk_translation_requests_total", "tmk_evaluation_jobs_total", "tmk_db_open_connections", "tmk_object_storage_free_bytes", "tmk_application_ready"} {
